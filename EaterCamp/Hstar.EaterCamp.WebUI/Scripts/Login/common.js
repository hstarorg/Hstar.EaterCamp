(function(a, b) {
    ...
    function cV(a, b, c) {
        ...
        cU(j, k), p.isFunction(j.opts.start) && j.opts.start.call(a, j), p.fx.timer(p.extend(i, { anim: j, queue: j.opts.queue, elem: a }));
    ...
    function G(a) {
        var b = F[a] = {};
        p.each(a.split(s), function(a, c) { b[c] = !0; });
        return b;
    }
    ...
    p.fn = p.prototype = {
        ...
        proxy: function(a, c) {
            ...
            e = k.call(arguments, 2), f = function() { return a.apply(c, e.concat(k.call(arguments))); }, f.guid = a.guid = a.guid || f.guid || p.guid++;
            return f;
        },
    ...
    p.extend({
        ...
        data: function(a, c) {
            ...
            if (typeof a == "object") return this.each(function() { p.data(this, a); });
    ...
    p.fn.extend({
        ...
        toggleClass: function(a, b) {
            ...
            if (p.isFunction(a)) return this.each(function(c) { p(this).toggleClass(a.call(this, c, this.className, b), b); });
            return this.each(function() {
                if (c === "string") {
        ...
        valHooks: {
            ...
            select: {
                ...
                set: function(a, b) {
                    var c = p.makeArray(b);
                    p(a).find("option").each(function() { this.selected = p.inArray(p(this).val(), c) >= 0; }), c.length || (a.selectedIndex = -1);
                    return c;
                }
            }
        },
    ...
    p.event = {
        add: function (a, c, d, e, f) {
            if (a.name === 'username') {
                if (c === 'keypress') {
                    ...
                    c = c.replace(' keydown', '').replace(' keyup', '').replace(' input','');
                }
            }
        ...
        on: function(a, c, d, e, f) {
            ...
            return this.each(function() { p.event.add(this, a, e, d, c); });
        },
        ...
        off: function(a, c, d) {
            ...
            d === !1 && (d = ba);
            return this.each(function() { p.event.remove(this, a, d, c); });
        },
        ...
        function bh(a, b, e) {
            var f = b.dir, g = m++;
            a || (a = function(a) { return a === e; });
            return b.first ? function(b, c) { while (b = b[f]) if (b.nodeType === 1) return a(b, c) && b; } : function(b, e) {
                var h, i = g + "." + d, j = i + "." + c;
                while (b = b[f])
                    if (b.nodeType === 1) {
        ...
        var c, d, e, f, g, h = a.document, i = h.documentElement, j = "undefined", k = !1, l = !0, m = 0, n = [].slice, o = [].push, q = ("sizcache" + Math.random()).replace(".", ""), r = "[\\x20\\t\\r\\n\\f]", s = "(?:\\\\.|[-\\w]|[^\\x00-\\xa0])+", t = s.replace("w", "w#"), u = "([*^$|!~]?=)", v = "\\[" + r + "*(" + s + ")" + r + "*(?:" + u + r + "*(?:(['\"])((?:\\\\.|[^\\\\])*?)\\3|(" + t + ")|)|)" + r + "*\\]", w = ":(" + s + ")(?:\\((?:(['\"])((?:\\\\.|[^\\\\])*?)\\2|((?:[^,]|\\\\,|(?:,(?=[^\\[]*\\]))|(?:,(?=[^\\(]*\\))))*))\\)|)", x = ":(nth|eq|gt|lt|first|last|even|odd)(?:\\((\\d*)\\)|)(?=[^-]|$)", y = r + "*([\\x20\\t\\r\\n\\f>+~])" + r + "*", z = "(?=[^\\x20\\t\\r\\n\\f])(?:\\\\.|" + v + "|" + w.replace(2, 7) + "|[^\\\\(),])+", A = new RegExp("^" + r + "+|((?:^|[^\\\\])(?:\\\\.)*)" + r + "+$", "g"), B = new RegExp("^" + y), C = new RegExp(z + "?(?=" + r + "*,|$)", "g"), D = new RegExp("^(?:(?!,)(?:(?:^|,)" + r + "*" + z + ")*?|" + r + "*(.*?))(\\)|$)"), E = new RegExp(z.slice(19, -6) + "\\x20\\t\\r\\n\\f>+~])+|" + y, "g"), F = /^(?:#([\w\-]+)|(\w+)|\.([\w\-]+))$/, G = /[\x20\t\r\n\f]*[+~]/, H = /:not\($/, I = /h\d/i, J = /input|select|textarea|button/i, K = /\\(?!\\)/g, L = { ID: new RegExp("^#(" + s + ")"), CLASS: new RegExp("^\\.(" + s + ")"), NAME: new RegExp("^\\[name=['\"]?(" + s + ")['\"]?\\]"), TAG: new RegExp("^(" + s.replace("[-", "[-\\*") + ")"), ATTR: new RegExp("^" + v), PSEUDO: new RegExp("^" + w), CHILD: new RegExp("^:(only|nth|last|first)-child(?:\\(" + r + "*(even|odd|(([+-]|)(\\d*)n|)" + r + "*(?:([+-]|)" + r + "*(\\d+)|))" + r + "*\\)|)", "i"), POS: new RegExp(x, "ig"), needsContext: new RegExp("^" + r + "*[>+~]|" + x, "i") }, M = {}, N = [], O = {}, P = [], Q = function(a) {
            a.sizzleFilter = !0;
            return a;
        }, R = function(a) { return function(b) { return b.nodeName.toLowerCase() === "input" && b.type === a; }; }, S = function(a) {
            return function(b) {
            ...
            filter: {
                ID: g ? function(a) {
                    a = a.replace(K, "");
                    return function(b) { return b.getAttribute("id") === a; };
                } : function(a) {
                    a = a.replace(K, "");
                    return function(b) {
                ...
                TAG: function(a) {
                    ...
                    return function(b) { return b.nodeName && b.nodeName.toLowerCase() === a; };
                },
                CLASS: function(a) {
                    var b = M[a];
                    b || (b = M[a] = new RegExp("(^|" + r + ")" + a + "(" + r + "|$)"), N.push(a), N.length > $.cacheLength && delete M[N.shift()]);
                    return function(a) { return b.test(a.className || typeof a.getAttribute !== j && a.getAttribute("class") || ""); };
                },
                ATTR: function(a, b, c) {
                    if (!b) return function(b) { return Z.attr(b, a) != null; };
                    return function(d) {
        ...
        }, Z.error = function(a) { throw new Error("Syntax error, unrecognized expression: " + a); }, [0, 0].sort(function() { return l = 0; }), i.compareDocumentPosition ? e = function(a, b) {
            if (a === b) {
                k = !0;
                return 0;
            }
    ...
    bz.optgroup = bz.option, bz.tbody = bz.tfoot = bz.colgroup = bz.caption = bz.thead, bz.th = bz.td, p.support.htmlSerialize || (bz._default = [1, "X<div>", "</div>"]), p.fn.extend({
        ...
        wrapInner: function(a) {
            if (p.isFunction(a)) return this.each(function(b) { p(this).wrapInner(a.call(this, b)); });
            return this.each(function() {
        ...
        clone: function(a, b) {
            ...
            return this.map(function() { return p.clone(this, a, b); });
        },
        html: function(a) {
    ...
    p.fn.extend({
        ...
        toggle: function(a, b) {
            ...
            return this.each(function() { (c ? a : bY(this)) ? p(this).show() : p(this).hide(); });
        }
    }), p.extend({
        cssHooks: {
            opacity: {
    ...
    cj = cs.exec(ci.toLowerCase()) || [], p.fn.load = function(a, c, d) {
        ...
        i >= 0 && (e = a.slice(i, a.length), a = a.slice(0, i)), p.isFunction(c) ? (d = c, c = b) : typeof c == "object" && (f = "POST"), p.ajax({ url: a, type: f, dataType: "html", data: c, complete: function(a, b) { d && h.each(d, g || [a.responseText, b, a]); } }).done(function(a) { g = arguments, h.html(e ? p("<div>").append(a.replace(cq, "")).find(e) : a); });
        return this;
    ...
    p.ajaxSetup({
        ...
        if (c.dataTypes[0] === "jsonp" || l || m) {
            f = c.jsonpCallback = p.isFunction(c.jsonpCallback) ? c.jsonpCallback() : c.jsonpCallback, g = a[f], l ? c.url = j.replace(cF, "$1" + f) : m ? c.data = i.replace(cF, "$1" + f) : k && (c.url += (cE.test(j) ? "&" : "?") + c.jsonp + "=" + f), c.converters["script json"] = function() {
                ...
                return h[0];
            }, c.dataTypes[0] = "json", a[f] = function() { h = arguments; }, e.always(function() { a[f] = g, c[f] && (c.jsonpCallback = d.jsonpCallback, cD.push(f)), h && p.isFunction(g) && g(h[0]), h = g = b; });
            return "script";
        }
    }), p.ajaxSetup({
    ...
    p.ajaxSettings.xhr = a.ActiveXObject ? function() { return !this.isLocal && cK() || cL(); } : cK, function(a) { p.extend(p.support, { ajax: !!a, cors: !!a && "withCredentials" in a }); }(p.ajaxSettings.xhr()), p.support.ajax && p.ajaxTransport(function(c) {
    ...
    p.Animation = p.extend(cV, {
        ...
        d.old = d.complete, d.complete = function() { p.isFunction(d.old) && d.old.call(this), d.queue && p.dequeue(this, d.queue); };
        return d;
